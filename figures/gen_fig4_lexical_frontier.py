...
DATA = ROOT / "results" / "R026_DOMURLS_R025_FRONTIER_COMBINED.csv"
...
SYSTEMS = [
    ...
    ("domurls_bert_frozen_embedding", "DomURLs-BERT", COLORS["domurls"]),
    ("char_cnn", "Char-CNN", COLORS["char"]),
]
LABELS = ["Lex-benign\nshape", "Lex-benign\n+ multi-IP", "Multi-IP\nDNS", "Low TTL"]
...
def main() -> None:
    ...
    save_fig(fig, "fig4_lexical_frontier")
